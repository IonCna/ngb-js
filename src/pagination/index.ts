...
export { NgbPaginationEllipsis } from "@ngb/pagination/ngb-pagination-ellipsis.directive";
export { NgbPaginationFirst } from "@ngb/pagination/ngb-pagination-first.directive";
export { NgbPaginationLast } from "@ngb/pagination/ngb-pagination-last.directive";
export { NgbPaginationNext } from "@ngb/pagination/ngb-pagination-next.directive";
