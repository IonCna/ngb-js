...
const bootstrapPopperMatches: Record<
	Placement,
...
export function getPopperClassPlacement(
	placement: Placement,
	isRTL: boolean,
): PopperPlacement {
...
export function getBootstrapBaseClassPlacement(
	baseClass: string,
...
export function getPopperOptions(
	{ placement, baseClass }: PositioningOptions,
	rtl: NgbRTL,
): Partial<Options> {
	...
	return {
		createPopper(positioningOption: PositioningOptions) {
			const updatePopperOptions =
				positioningOption.updatePopperOptions || noMod;
