...
DemoModalModule.component(
	DemoModalComponent.$name,
	DemoModalComponent.$factory,
);
DemoModalModule.component(
	DemoModalContentComponent.$name,
	DemoModalContentComponent.$factory,
);
DemoModalModule.component(
	DemoModalScrollableContentComponent.$name,
	DemoModalScrollableContentComponent.$factory,
);
DemoModalModule.component(
	DemoModalUpdateOptionsContentComponent.$name,
	DemoModalUpdateOptionsContentComponent.$factory,
);
